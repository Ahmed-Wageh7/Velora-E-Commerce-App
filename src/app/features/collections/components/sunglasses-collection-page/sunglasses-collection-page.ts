...
export class SunglassesCollectionPageComponent extends ProductCollectionPageBase {
  protected override readonly defaultBreadcrumbParentLabel = 'Veloura Sunglasses';
}
