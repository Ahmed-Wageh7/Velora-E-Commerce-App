...
@Component({
  ...
  templateUrl: './watch-collection-page.html',
  styleUrl: '../../pages/frankel-collection/frankel-collection.scss',
})
export class WatchCollectionPageComponent {
  ...
  protected readonly heroImageUrl = computed(() => {
    ...
    return heroImageFile.startsWith('/') ? heroImageFile : `/${heroImageFile}`;
  });
  protected readonly watchProducts$ = toObservable(
    computed(() => ({
